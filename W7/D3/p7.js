...
const userToken = jwt.sign({ userId: 1, role: "user", email: "Naveen@email.com" }, secretKey, { expiresIn: "1h" });
console.log("UserToken:", userToken);
const adminToken = jwt.sign({ userId: 2, role: "admin", email: "suii@email.com" }, secretKey, { expiresIn: "1h" });
